...
session_start();
// Allow access for admin (maQuanLy) OR staff (maNhanVien)
...
$row_quanly = [];
// If admin, load admin row; if staff, prefer staff display name
...
} elseif (isset($_SESSION['maNhanVien'])) {
  // For staff, we don't need a full admin row; set display name from session
  $row_quanly['tenQuanLy'] = $_SESSION['tenNhanVien'] ?? '';
}
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h3 class="card-title">Danh sách yêu cầu hỗ trợ từ khách hàng</h3>
                </div>
                <div class="card-body">
